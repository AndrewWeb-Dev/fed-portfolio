...
function hackeryou_styles(){
	...
	wp_enqueue_style('flickity', 'https://npmcdn.com/flickity@2.0/dist/flickity.css', null, null, 'screen');

	wp_enqueue_style('animate', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css', null, null, 'screen');
}
...
function hackeryou_posted_on() {
	printf('<span class="%1$s">Posted on</span> %2$s <span class="meta-sep"></span> %3$s',
